...
public class WmChannelServiceImpl extends ServiceImpl<WmChannelMapper, WmChannel> implements WmChannelService {
    ...
    public ResponseResult listch(ChannelDto channelDto) {
        ...
        if(channelDto.getName()!=null){
            lambdaQueryWrapper.like(WmChannel::getName,channelDto.getName());
        }
        page=page(page,lambdaQueryWrapper);

        PageResponseResult responseResult=new PageResponseResult(channelDto.getPage(),channelDto.getSize(),(int)page.getTotal());
